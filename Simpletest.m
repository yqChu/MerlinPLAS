...
Ydf = 3; Ydb = Ydf*10; pl_mod_fold = 0.8; pl_mod_bend = pl_mod_fold*10;
...
%             59, 1, 0, 1];
% indp = 59;
% ff = -1*ones(length(indp),1);   % 30 is the total amount of displacement (load)
...
%% Perform analysis
% Assemble input data
[truss, angles, AnalyInputOpt] = PrepareData(Node,Panel,Supp,Load,AnalyInputOpt,Ydf,Ydb,pl_mod_fold,pl_mod_bend);
