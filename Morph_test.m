...
AnalyInputOpt = struct(...
    ...
    'Kb',Kb,...
    'Kf',Kf,...
    'RotSprBend', @(he,h0,Kb,L0)EnhancedLinear(he,h0,Kb,L0,0,360),...
    'RotSprFold', @(he,h0,Kf,L0)EnhancedLinear(he,h0,Kf,L0,0,360),...
